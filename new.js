...
function checkCashRegister(price, cash, cid) {
  ...
  const changeAvail = getTotalCash(cid);
  cashRegister.status = getTotalStatus(changeNeeded, changeAvail)
...
function getTotalStatus(changeNeeded, changeAvail) {
...
function getTotalCash(changeInDrawer) {
  let total = 0;
